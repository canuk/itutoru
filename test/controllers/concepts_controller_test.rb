...
class ConceptsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create concept" do
    assert_difference("Concept.count") do
      post concepts_url, params: { concept: { concept_prompt: @concept.concept_prompt, name: @concept.name, notes: @concept.notes, subject_matter_id: @concept.subject_matter_id } }
    end
  ...
  test "should update concept" do
    patch concept_url(@concept), params: { concept: { concept_prompt: @concept.concept_prompt, name: @concept.name, notes: @concept.notes, subject_matter_id: @concept.subject_matter_id } }
